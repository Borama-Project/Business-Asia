<div class="col-lg-12"> 
	...
	<div class="col-lg-12 pd-lef-10  pd-right-0 list-group-item">
        <div class="form-group col-lg-3 pd-lef-0">
            <select ng-model="app.selectType" class="form-control" id="tagList"  name="select" required>
                <option value=""> Select Type</option>
                <option ng-repeat="item in categorysLists" value="@{{ item.id }}"> @{{ item.name }} </option>
            </select>
        </div>
        <div class="form-group col-lg-3 pd-lef-0">
            <select ng-model="app.selectCategory" class="form-control" id="tagList"  name="select" required>
    ...
    <div class="col-lg-8 pd-lef-10  pd-right-0 list-group-item">
    ...
    <div class="col-lg-4 pd-lef-10  pd-right-0 list-group-item">
        <h3>Search List</h3>
    </div>
</div>
